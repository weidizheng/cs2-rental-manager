...
- 浏览器扩展的自动读取目前仅支持 C5；ECO、IGXE 可通过剪贴板导入，不需要扩展。
...
5. 如需直接读取已登录的 C5 页面，可按 [browser-extension/README.md](browser-extension/README.md) 加载本地扩展并点击“通过浏览器同步 C5”。安全验证必须在浏览器中人工完成。
